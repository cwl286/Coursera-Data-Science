...
For this data set, the accuracy is roughly 99.4% with out-of-sample error roughly 0.6%. This could be a consequence of high correlation between predictors.
