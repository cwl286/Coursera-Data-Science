...
# Set the directory for RStudio

setwd("C:/Users/christopher/Desktop/Coursera-Data-Science")

# Question 1
# The en_US.blogs.txt  file is how many megabytes?

file.info("Capstone-Project/final/en_US/en_US.blogs.txt")$size / 1024^2


# Question 2
# The en_US.twitter.txt has how many lines of text?

blogs <- readLines("Capstone-Project/final/en_US/en_US.blogs.txt")
news <- readLines("Capstone-Project/final/en_US/en_US.news.txt")
twitter <- readLines("Capstone-Project/final/en_US/en_US.twitter.txt")
length(twitter)
